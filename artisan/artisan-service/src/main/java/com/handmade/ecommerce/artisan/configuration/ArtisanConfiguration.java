...
public class ArtisanConfiguration {
    ...
    @Bean
    EntityStore<Artisan> artisanEntityStore() {
        return new ArtisanEntityStore();
    }

    @Bean
    @Autowired
    StateEntityServiceImpl<Artisan> _artisanStateEntityService_(
    ...
    @Bean
    ArtisanHealthChecker artisanHealthChecker() {
        return new ArtisanHealthChecker();
    }

    @Bean
    STMTransitionAction<Artisan> defaultartisanSTMTransitionAction() {
    ...
    @Bean
    @Autowired
    StmBodyTypeSelector artisanBodyTypeSelector(
            @Qualifier("artisanActionsInfoProvider") STMActionsInfoProvider artisanInfoProvider,
    ...
    @Bean
    @Autowired
    Function<ChenileExchange, String[]> artisanEventAuthoritiesSupplier(
            @Qualifier("artisanActionsInfoProvider") STMActionsInfoProvider artisanInfoProvider)
            throws Exception {
